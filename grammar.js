 ...
 * charNoBQOrNL             := [\u0020-\u005f\u0061-\u007f]
 * classDef                 := _disable_semicolon (identifier: name) (type_parameters?: type_parameters)
 ...
 *     (_disable_semicolon (identifier: name) (type_parameters?: type_parameters)
 (constructor_annotation*: constructor_annotations)
 (access_modifier?: access_modifier)
 (class_parameters*: class_parameters)
 ...
 * objectDef                := _disable_semicolon (identifier: name) $classTemplateOpt
 _enable_semicolon

 *     (_disable_semicolon (identifier: name) ('extends' _class_template | ('extends'? template_body)?)
 _enable_semicolon
)
 * opchar                   := [\-!#%&*+/\\:<=>?@\u005e\u007c~]
 ...
 * traitDef                 := _disable_semicolon (identifier: name) (type_parameters?: type_parameters) $traitTemplateOpt
 _enable_semicolon

 *     (_disable_semicolon (identifier: name) (type_parameters?: type_parameters) ('extends' _trait_template | ('extends'? template_body)?)
 _enable_semicolon
)
...
module.exports = grammar({
  ...
  /*
   * scalar2c.ebnf:5
   * externals  ::= { _automatic_semicolon _disable_semicolon _enable_semicolon }
   */
  externals: $ => [$._automatic_semicolon, $._disable_semicolon, $._enable_semicolon],
  /*
   * scalar2c.ebnf:7
  ...
  rules: {
    ...
    /*
     * scalar2c.ebnf:34
     * _block_class_definition      ::= annotation* local_modifier* 'case'? 'class' $classDef
     */
    ...
    /*
     * scalar2c.ebnf:36
     * _template_object_definition  ::= annotation* modifiers? 'case'? 'object' $objectDef
     */
    ...
    /*
     * scalar2c.ebnf:37
     * _template_trait_definition   ::= annotation* modifiers? 'trait' $traitDef
     */
