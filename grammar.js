...
/*
 * inline constants: 
 * blockStatementSeq        := _block_statement (_semicolon _block_statement)*
 * charEscapeSeq            := \\[btnfr"'\\]
...
module.exports = grammar({
  ...
  rules: {
    ...
    compilation_unit: $ => choice(
                             ...
                             seq($._block_statement, optional(repeat(seq($._semicolon, $._block_statement))))
                           ),
    /*
     * scalar2c.ebnf:17-23
     * _literal                     ::= number
     ...
     *                                | _expression
     */
    _template_statement: $ => choice($.import_declaration, $.val_definition, $._expression),
    /*
     * scalar2c.ebnf:32-34
    ...
    /*
     * scalar2c.ebnf:35
     * _block_class_definition      ::= _annotations? local_modifier* $classDef
     */
    ...
    /*
     * scalar2c.ebnf:55
     * template_body                ::= _block_newline? '{' self_type? _template_statement (_semicolon _template_statement)* '}'
     */
    template_body: $ => seq(
                          optional($._block_newline),
                          '{',
                          optional($.self_type),
                          $._template_statement,
     ...
     * _local_val_definition        ::= 1(_annotations? ('implicit' -> implicit_modifier)? ('lazy' -> lazy_modifier)?
    ...
    /*
     * scalar2c.ebnf:113
     * val_definition               ::= _annotations? modifiers? 'val' (_pattern: pattern) (':' (_type: type))? '=' (_expression: value)
     */
    val_definition: $ => seq(
                           optional($._annotations),
                           optional($.modifiers),
    ...
    /*
     * scalar2c.ebnf:114
     * val_declaration              ::= _annotations? modifiers? 'val' ((identifier: name) (',' (identifier: name))*) ':' (_type: type)
     */
    val_declaration: $ => seq(
                            optional($._annotations),
                            optional($.modifiers),
    ...
    /*
     * scalar2c.ebnf:115
     * var_declaration              ::= _annotations? modifiers? 'var' ((identifier: name) (',' (identifier: name))*) ':' (_type: type)
     */
    var_declaration: $ => seq(
                            optional($._annotations),
                            optional($.modifiers),
    ...
    /*
     * scalar2c.ebnf:116
     * var_definition               ::= _annotations? modifiers? 'var' (_pattern: pattern) (':' (_type: type))? '=' (_expression: value)
     */
    var_definition: $ => seq(
                           optional($._annotations),
                           optional($.modifiers),
    ...
    /*
     * scalar2c.ebnf:117-118
     * type_definition              ::= _annotations? modifiers? 'type' (_type_identifier: name)
    ...
    /*
     * scalar2c.ebnf:119-121
     * function_definition          ::= _annotations? modifiers? 'def' (identifier: name) (type_parameters?: type_parameters)
     ...
     * function_declaration         ::= _annotations? modifiers? 'def' (identifier: name) (type_parameters?: type_parameters)
     *                                    (parameters*: parameters) (':' (_type: return_type))?
     */
    ...
    /*
     * scalar2c.ebnf:207
     * for_expression               ::= 3<('for' ('(' enumerators ')' | '{' enumerators _semicolon?  '}') _single_newline* 'yield'? _expression)
     */
    ...
    /*
     * scalar2c.ebnf:209
     * while_expression             ::= 2('while' '(' _expression ')' _block_newline? _expression)
     */
    while_expression: $ => prec(
                             2,
                             seq('while', '(', $._expression, ')', optional($._block_newline), $._expression)
                           ),
    /*
     * scalar2c.ebnf:210
