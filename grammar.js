...
module.exports = grammar({
  ...
  rules: {
    ...
    _import_expr: $ => seq(
                         ...
                         field(
                           'import_selection',
                           choice($.identifier, alias('_', $.wildcard), $.import_selectors)
                         )
                       ),
    /*
     * scalar2c.ebnf:91
    ...
    _simple_type: $ => choice(
                         ...
                         $.type_projection,
                         $.tuple_types,
                         seq($._simple_type, $.type_parameters)
                       ),
    /*
     * scalar2c.ebnf:266-267
