...
module.exports = grammar({
  ...
  rules: {
    /*
     * scalar2c.ebnf:22-23
     * compilation_unit                     ::= ('package' qualified_identifier _semicolon)*
     *                                        | _literal+
     */
    compilation_unit: $ => choice(
                             repeat(seq('package', $.qualified_identifier, $._semicolon)),
                             repeat1($._literal)
                           ),
    /*
     * scalar2c.ebnf:24-30
