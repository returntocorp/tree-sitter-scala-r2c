 ...
 * class_template_opt       := ('extends' _class_template | ('extends'? template_body)?)
 * decimal_numeral          := [0-9]+
 ...
 * objectDef                := (identifier: name) $class_template_opt
