...
enum {
  ...
  anon_sym_final = 27,
  anon_sym_sealed = 28,
  anon_sym_implicit = 29,
  anon_sym_lazy = 30,
  anon_sym_private = 31,
  anon_sym_protected = 32,
  anon_sym_this = 33,
  ...
  aux_sym_number_token2 = 56,
  anon_sym_true = 57,
  anon_sym_false = 58,
  sym_character_literal = 59,
  sym_symbol_literal = 60,
  sym__interpolated_string_start = 61,
  sym__interpolated_multiline_string_start = 62,
  anon_sym_DOLLAR = 63,
  anon_sym_SEMI = 64,
  sym_comment = 65,
  sym__automatic_semicolon = 66,
  sym__simple_string = 67,
  sym__simple_multiline_string = 68,
  sym__interpolated_string_middle = 69,
  sym__interpolated_string_end = 70,
  sym__interpolated_multiline_string_middle = 71,
  sym__interpolated_multiline_string_end = 72,
  sym_foo = 73,
  sym__literal = 74,
  sym_number = 75,
  sym_boolean_literal = 76,
  sym_string = 77,
  aux_sym_foo_repeat1 = 78,
};
...
static const char *ts_symbol_names[] = {
  ...
  [sym_string] = "string",
  [aux_sym_foo_repeat1] = "foo_repeat1",
};
...
static TSSymbol ts_symbol_map[] = {
  ...
  [aux_sym_foo_repeat1] = aux_sym_foo_repeat1,
};
  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == 170 ||
          ...
          lookahead == 43000 ||
          lookahead == 43001 ||
          (43868 <= lookahead && lookahead <= 43871)) ADVANCE(76);
      if (('a' <= lookahead && lookahead <= 'z') ||
          ...
          (66776 <= lookahead && lookahead <= 66811)) ADVANCE(76);
      if (('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == 186 ||
          ...
          (68297 <= lookahead && lookahead <= 68309)) ADVANCE(76);
      END_STATE();
    case 1:
    ...
    case 8:
      ...
      if ((' ' <= lookahead && lookahead <= '&') ||
          ('(' <= lookahead && lookahead <= 127)) ADVANCE(94);
      if (lookahead != 0 &&
          lookahead != '\n' &&
    ...
    case 9:
      ...
      if (('$' <= lookahead && lookahead <= 'z')) ADVANCE(9);
      if (sym_identifier_character_set_4(lookahead)) ADVANCE(21);
      END_STATE();
    case 10:
      if (lookahead == '\\') ADVANCE(11);
      if (lookahead == '`') ADVANCE(62);
      ...
      if ((' ' <= lookahead && lookahead <= 127)) ADVANCE(16);
      END_STATE();
    case 11:
      if (lookahead == '\\') ADVANCE(11);
      if (lookahead == '`') ADVANCE(62);
    ...
    case 14:
      if (lookahead == '\\') ADVANCE(11);
      if (lookahead == '`') ADVANCE(62);
      if (('_' <= lookahead && lookahead <= 'z')) ADVANCE(9);
      if ((' ' <= lookahead && lookahead <= 127)) ADVANCE(16);
      if (lookahead == 170 ||
          lookahead == 181 ||
          lookahead == 187 ||
          ...
          (65345 <= lookahead && lookahead <= 65370) ||
          (66600 <= lookahead && lookahead <= 66639) ||
          (66776 <= lookahead && lookahead <= 66811)) ADVANCE(21);
      END_STATE();
    case 15:
      if (lookahead == '\\') ADVANCE(11);
      if (lookahead == '`') ADVANCE(62);
    ...
    case 20:
      ...
      if (lookahead == '`') ADVANCE(62);
      if (sym_identifier_character_set_9(lookahead)) ADVANCE(22);
      if (sym_identifier_character_set_10(lookahead)) ADVANCE(21);
      END_STATE();
    case 21:
      if (lookahead == '_') ADVANCE(20);
      if (lookahead == '`') ADVANCE(62);
    ...
    case 46:
      ...
      if (sym_identifier_character_set_9(lookahead)) ADVANCE(77);
      END_STATE();
    case 47:
    ...
    case 64:
      ...
      if (sym_identifier_character_set_12(lookahead)) ADVANCE(77);
      END_STATE();
    case 65:
      ACCEPT_TOKEN(sym_identifier);
      if (lookahead == '*') ADVANCE(65);
      if (lookahead == '/') ADVANCE(77);
      if (sym_identifier_character_set_12(lookahead)) ADVANCE(66);
      if (lookahead != 0) ADVANCE(6);
      END_STATE();
    case 66:
      ACCEPT_TOKEN(sym_identifier);
    ...
    case 69:
      ...
      if (sym_identifier_character_set_10(lookahead)) ADVANCE(76);
      END_STATE();
    case 70:
      ACCEPT_TOKEN(sym_identifier);
      if (lookahead == '_') ADVANCE(75);
    ...
    case 78:
      ACCEPT_TOKEN(sym_identifier);
      if (sym_identifier_character_set_9(lookahead)) ADVANCE(78);
      if (lookahead != 0 &&
          lookahead != '\n') ADVANCE(101);
      END_STATE();
    case 79:
...
static uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_symbol_literal] = ACTIONS(13),
    [sym_comment] = ACTIONS(15),
    [sym__simple_string] = ACTIONS(17),
    [sym__simple_multiline_string] = ACTIONS(17),
  },
};
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [19] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_foo, 1),
  [21] = {.entry = {.count = 1, .reusable = true}}, SHIFT(3),
  [23] = {.entry = {.count = 1, .reusable = false}}, SHIFT(3),
  [25] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_foo_repeat1, 2),
  [27] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_foo_repeat1, 2), SHIFT_REPEAT(3),
  [30] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_foo_repeat1, 2), SHIFT_REPEAT(5),
  [33] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_foo_repeat1, 2), SHIFT_REPEAT(5),
  [36] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_foo_repeat1, 2), SHIFT_REPEAT(6),
  [39] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_foo_repeat1, 2), SHIFT_REPEAT(3),
  [42] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_foo_repeat1, 2), SHIFT_REPEAT(4),
  [45] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 1),
  [47] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string, 1),
  [49] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_number, 1),
  [51] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_number, 1),
  [53] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_boolean_literal, 1),
  [55] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_boolean_literal, 1),
